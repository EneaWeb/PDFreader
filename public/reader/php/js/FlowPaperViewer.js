...
window.FlowPaperViewer_Zine = function(f, c, d) {
    ...
    this.ua = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7";
    this.Mh = this.Lh = "assets_zine/bttnPrint.png";
    this.wg = this.Fh = "assets_zine/bttnBookView.png";
    this.Oh = this.Bg = "assets_zine/bttnSinglePage.png";
    this.Rh = this.Eg = this.Qh = this.Dg = this.Ph = this.Cg = "assets_zine/";
    this.yg = "assets_zine/bttnFullscreen.png";
    this.Gh = this.xg = this.Ih = this.zg = this.Jh = this.Ag = this.Hh = "assets_zine/";
    this.Of = "assets_zine/bar.png";
    this.ap = "assets_zine/bttnDownload.png";
    this.gp = "assets_zine/bttnPrint.png";
    this.np = "assets_zine/bttnSocialShare.png";
    this.$o = "assets_zine/bttnSinglePage.png";
    this.qp = "assets_zine/bttnBookView.png";
    this.ep = "assets_zine/bttnHand.png";
    this.fp = "assets_zine/bttnPrevPage.png";
    this.hp = "assets_zine/bttnPrevNext.png";
    this.rp = "assets_zine/bttnFind.png";
    this.cp = "assets_zine/bttnFullscreen.png";
    this.pp = "assets_zine/bttnTextSelect.png";
